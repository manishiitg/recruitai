...
sudo docker-compose -f docker-compose-gpu-qafull.yml build
sudo docker-compose -f docker-compose-gpu-qafull.yml up -d
sudo docker-compose -f docker-compose-gpu-qafull.yml up -d --scale=qafullgpu=2
...
do
  ...
  sudo docker-compose -f docker-compose-gpu-qafull.yml restart
